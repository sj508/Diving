                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" placeholder="password" minlength="6" type="password" class="form-control" name="password" required>
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" placeholder="confirm password" minlength="6" type="password" class="form-control" name="password_confirmation" required>
